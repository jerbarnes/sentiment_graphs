...
from classification_data_utils import ABSATokenizer, TargetPooledClassification
...
def train(args):
    ...
    #>>>>> validation
    if args.do_valid:
        valid_examples = processor.get_dev_examples(args.data_dir, "dev_rels.json", method=args.method)
    ...
    model = TargetPooledClassification("bert-base-multilingual-cased",
                                       hidden_dropout_prob=0.3,
                                       num_labels=len(label_list),
                                       pool_target=args.pooling)
    model.cuda()
...
if __name__=="__main__":
    ...
    parser.add_argument("--method",
                        default=0,
                        type=int,
                        help="""Determines how to incorporate annotations
                                1 (default): replace entity1 and entity2 with entity reps [$E1] and [$E2]
                                2: replace entity1 and entity2 with entity reps for each token in the entity
                                3: surround tokens for each entity with entity markers
                                4: place entities after sentence, separated by [SEP] markers""")
    ...
    parser.add_argument("--data_dir",
                        ...
                        type=str,
                        required=True,
                        help="The location of the data jsons.")
